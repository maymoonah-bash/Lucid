...
//  lucidWidget
//
//  Created by Amaal on 16/06/1444 AH.
//
...
struct lucidWidgetEntryView : View {
...
struct lucidWidget: Widget {
    let kind: String = "lucidWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            lucidWidgetEntryView(entry: entry)
        }
...
struct lucidWidget_Previews: PreviewProvider {
    static var previews: some View {
        lucidWidgetEntryView(entry: SimpleEntry(date: Date()))
